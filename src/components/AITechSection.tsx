      ...
      <div className="container mx-auto px-6">
        ...
        >
          <div className="text-center">
            <div className="text-5xl font-bold text-sms-neonBlue mb-2">30</div>
            <div className="text-lg text-sms-lightGray">Days advance warning</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-sms-neonBlue mb-2">$2M+</div>
            <div className="text-lg text-sms-lightGray">Average savings per vessel</div>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-sms-neonBlue mb-2">0</div>
            <div className="text-lg text-sms-lightGray">Unexpected failures</div>
          </div>
        </motion.div>
      </div>
    </section>
