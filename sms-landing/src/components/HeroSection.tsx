      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          >
            ...
            <Link
              to="/login"
              className="inline-flex items-center px-8 py-3 border-2 border-sms-electricBlue text-sms-electricBlue 
                       font-semibold rounded-lg hover:bg-sms-electricBlue/10 transition-all duration-300"
            >
              Customer Portal
