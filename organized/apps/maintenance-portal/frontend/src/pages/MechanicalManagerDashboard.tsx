            ...
            <div className="space-y-3">
              <div className="p-3 bg-green-900/20 border border-green-500/30 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">142 Days</span>
                </div>
                <p className="text-xs text-gray-400">Zero mechanical incidents fleet-wide</p>
              ...
              <div className="p-3 bg-gray-800 rounded-lg">
                ...
                <div className="space-y-2">
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → Fatigue Management Workshop (July 20)
                  </button>
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → Team Building Event Planning
                  </button>
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → Wellness Check-in Survey Results
                  </button>
                </div>
              </div>
              <div className="p-3 bg-amber-900/20 border border-amber-500/30 rounded-lg">
                <p className="text-sm font-medium text-white">Compliance Alert</p>
                <p className="text-xs text-gray-400 mt-1">8 team members due for rotating equipment certification renewal within 45 days.</p>
              </div>
            </div>
          </div>
        </div>
