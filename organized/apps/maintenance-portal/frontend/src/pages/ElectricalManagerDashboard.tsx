...
import {
  ...
  FiHeart, FiCpu, FiFileText, FiPercent, FiTrendingDown
} from 'react-icons/fi';
          ...
          <div className="bg-sms-dark/60 backdrop-blur-sm border border-gray-700 rounded-xl p-6">
            ...
            <div className="space-y-3">
              <div className="p-3 bg-green-900/20 border border-green-500/30 rounded-lg">
                <div className="flex items-center justify-between mb-2">
                  <p className="text-sm font-medium text-white">Safety Performance</p>
                  <span className="text-xs px-2 py-1 bg-green-500/20 text-green-400 rounded">185 Days</span>
                </div>
                <p className="text-xs text-gray-400">Zero electrical incidents fleet-wide</p>
                <div className="w-full bg-gray-700 rounded-full h-2 mt-2">
                  <div className="bg-green-500 h-2 rounded-full" style={{ width: '92%' }}></div>
                </div>
              </div>
              <div className="p-3 bg-gray-800 rounded-lg">
                <p className="text-sm font-medium text-white mb-2">Mental Health Resources</p>
                <div className="space-y-2">
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → 24/7 Employee Assistance Program
                  </button>
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → Stress Management Workshop (July 15)
                  </button>
                  <button className="w-full text-left text-xs text-gray-400 hover:text-white transition-colors">
                    → Anonymous Wellbeing Survey Results
                  </button>
                </div>
              </div>
              <div className="p-3 bg-amber-900/20 border border-amber-500/30 rounded-lg">
                <p className="text-sm font-medium text-white">Compliance Alert</p>
                <p className="text-xs text-gray-400 mt-1">5 team members due for electrical safety recertification within 30 days.</p>
              </div>
            </div>
          </div>
        </div>
