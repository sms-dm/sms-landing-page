  ...
  try {
    ...
    await dbRun(`
      CREATE TABLE IF NOT EXISTS users (
        ...
        role TEXT NOT NULL CHECK (role IN ('technician', 'manager', 'admin')), -- base role (technician includes Electrician, Mechanic, HSE)
        avatar_url TEXT,
...
const insertDemoData = async () => {
  try {
    ...
    // Insert demo users with generic names
    const users = [
      ['demo.tech@oceanic.com', 'Alex', 'Thompson', 'technician', '/assets/avatars/tech1.svg'],
      ['demo.manager@oceanic.com', 'Sarah', 'Mitchell', 'manager', '/assets/avatars/manager1.svg'],
      ['demo.admin@oceanic.com', 'System', 'Admin', 'admin', null],
      // New demo accounts with their specific roles
      ['john.doe@oceanic.com', 'John', 'Doe', 'technician', '/assets/avatars/tech2.svg'], // Electrician
      ['mike.chen@oceanic.com', 'Mike', 'Chen', 'technician', '/assets/avatars/tech3.svg'], // Mechanic
      ['sarah.williams@oceanic.com', 'Sarah', 'Williams', 'technician', '/assets/avatars/tech4.svg'], // HSE Officer
      ['tom.rodriguez@oceanic.com', 'Tom', 'Rodriguez', 'manager', '/assets/avatars/manager2.svg'], // Electrical Manager
      ['james.wilson@oceanic.com', 'James', 'Wilson', 'manager', '/assets/avatars/manager3.svg'], // Mechanical Manager
      ['lisa.anderson@oceanic.com', 'Lisa', 'Anderson', 'manager', '/assets/avatars/manager4.svg'], // HSE Manager
      ['admin@smsportal.com', 'SMS Portal', 'Admin', 'admin', null] // SMS Portal Admin
    ];
    ...
    for (const [email, firstName, lastName, role, avatar] of users) {
      // Password is 'demo123' for all demo users
