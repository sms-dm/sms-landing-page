...
export { useGetVesselsNeedingOnboardingQuery } from '../hooks/useVessels';
...
export const managerApi = {
  ...
  getVesselsNeedingOnboarding: async (): Promise<Vessel[]> => {
    const response = await api.get('/vessels/onboarding/needed');
    return response.data.data;
  },
